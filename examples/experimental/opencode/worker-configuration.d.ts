/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 780a3e2597791c0d187bc981a15ad2fc)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "OpenCodeSandbox" | "CodeSandbox";
	}
	interface Env {
		OPENAI_API_KEY: string;
		OPENCODE: DurableObjectNamespace<import("./worker/src/index").OpenCodeSandbox>;
		SANDBOX: DurableObjectNamespace<import("./worker/src/index").CodeSandbox>;
	}
}
